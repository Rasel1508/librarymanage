...
$status=1;
$sql="INSERT INTO  tblstudents(StudentId,FullName,Address,Street,City,Age,MobileNumber,EmailId,Password,Status) VALUES(:StudentId,:fname,:address,:street,:city,:age,:mobileno,:email,:password,:status)";
...
<input class="form-control" type="text" name="street" autocomplete="off" required />
</div>
